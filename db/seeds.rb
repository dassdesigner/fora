...
t1 = Tag.create({title: "Life"})
t2 = Tag.create({title: "College"})
t3 = Tag.create({title: "Meta"})
t4 = Tag.create({title: "Bridges"})
t5 = Tag.create({title: "Quests"})
t6 = Tag.create({title: "Colors"})
t7 = Tag.create({title: "Bridge Crossing"})
t8 = Tag.create({title: "Magic"})
t9 = Tag.create({title: "The Joy of Learning"})
t10 = Tag.create({title: "Wizadry"})
t11 = Tag.create({title: "Grails"})
t12 = Tag.create({title: "Swallows"})
